        ...
        <Card>
          <CardBody>
            <div className="text-center">
              <h3 className="text-lg font-semibold text-gray-900">総精算回数</h3>
          ...
          <CardBody>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mt-1">
                {((stats.completedCount / stats.totalSettlements) * 100).toFixed(1)}%
              </p>
            </div>
          </CardBody>
        </Card>
        ...
        <Card>
          <CardBody>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mt-1">
                {((stats.pendingCount / stats.totalSettlements) * 100).toFixed(1)}%
              </p>
            </div>
          </CardBody>
        </Card>
        ...
        <CardBody>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4 bg-green-50 rounded-lg">
              <h4 className="text-sm font-medium text-green-800">受け取り合計</h4>
              ...
              <div key={month.month} className="border rounded-lg p-4">
                ...
                <div className="mt-3">
                  <div className="flex justify-between text-xs text-gray-600 mb-1">
                    <span>精算頻度</span>
                    <span>
                      {Math.max(10, (month.count / Math.max(...stats.monthlyTrend.map(m => m.count))) * 100).toFixed(0)}%
                    </span>
                  </div>
        ...
        <CardBody>
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              <h4 className="font-medium text-blue-900 mb-2">💡 精算パターン分析</h4>
            ...
            <div className="p-4 bg-yellow-50 rounded-lg">
              ...
              <p className="text-sm text-yellow-800">
                精算完了率は{((stats.completedCount / stats.totalSettlements) * 100).toFixed(1)}%です。
                {stats.pendingCount > 0 && `${stats.pendingCount}件の未完了精算があります。`}
              </p>
            </div>
          </div>
        </CardBody>
